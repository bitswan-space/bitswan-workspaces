...
func GetLatestBitswanGitopsVersion() (string, error) {
	...
	getLatestVersionUrl := "https://hub.docker.com/v2/repositories/bitswan/gitops/tags/"
...
func GetLatestBitswanEditorVersion() (string, error) {
	getLatestVersionUrl := "https://hub.docker.com/v2/repositories/bitswan/bitswan-editor/tags/"
	resp, err := http.Get(getLatestVersionUrl)
	if err != nil {
		return "latest", err
	}
